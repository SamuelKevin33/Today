...
<body >
    ...
    <nav class="td_nav">
      ...
      <div class="td_navmiddle">
        <ul>
          ...
          <li><a class="td_navlink td_navmask" href="foreign_fruit.html">进口水果</a></li>
      ...
      <div class="td_navright">
        ...
        <div class="floatright">
         <a id="car" class="td_navright_a " v-on:click="test" >购物车</a>
         </div>
  ...
  <div class="map"><a href="tdindex.html">首页 </a>> 进口水果</div>
  <section class="filter_section">
    <div class="filter">
      ...
      <div class="filter_list">
        ...
        <a class="filter_quanbu_active">
          <span class="filter_fruit filter_active">默认</span>
        </a>
        <div class="filter_list_name">
          <a v-on:click="order">
    ...
    <div class="fruit_list">
      <ul class="fruit_content_ul">
          <li class="fruit_content_li" v-for="(value,index) in fruitforeign">
          <div class="fruit_content_center">

          <img class="fruit_content_image" v-bind:src="'http://47.106.111.76/todaystore/public/Home/images/'+value.fruitname+'.jpg'"/>
          <p class="fruit_content_title">{{fruitname}}</p>
          <p class="fruit_content_weight">{{fruitweight}}g</p>
          <p class="fruit_content_price">￥{{fruitprice}}</p>
